# Generated by Django 4.0.3 on 2022-04-17 03:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, db_column='Nombre', max_length=100, null=True, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, db_column='Nombre', max_length=45, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(blank=True, db_column='Nombre', max_length=50, null=True, unique=True)),
                ('estado', models.CharField(choices=[('1', 'Activo'), ('2', 'Inactivo')], default=1, max_length=1)),
            ],
            options={
                'db_table': 'municipios',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Pais', models.CharField(blank=True, db_column='Nombre', max_length=20, null=True)),
                ('nacionalidad', models.CharField(blank=True, db_column='Nacionalidad', max_length=20, null=True, unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_documento', models.IntegerField(blank=True, db_column='No_Documento', null=True, unique=True)),
                ...
                ('correo', models.CharField(blank=True, db_column='Correo', max_length=45, null=True)),
                ('estado', models.CharField(choices=[('0', 'PreAprobado'), ('1', 'Aprobado'), ('2', 'Inactivo')], default=1, max_length=1)),
                ('Nacionalidad_idPais', models.ManyToManyField(db_column='Nacionalidad_idPais', to='appInfancia.nacionalidad')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'managed': True,
                'unique_together': {('idTipodiscapacidad', 'idpersona')},
            },
        ),
        migrations.CreateModel(
            name='Seccion',
        ...
        migrations.CreateModel(
            name='NacionalidadHasPersona',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('IdNacionalidad', models.ForeignKey(db_column='IdNacionalidad', on_delete=django.db.models.deletion.DO_NOTHING, to='appInfancia.lengua')),
                ('idpersona', models.ForeignKey(db_column='idpersona', on_delete=django.db.models.deletion.DO_NOTHING, to='appInfancia.persona')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idpersona', models.ForeignKey(db_column='idpersona', on_delete=django.db.models.deletion.DO_NOTHING, to='appInfancia.persona')),
                ('len_idlengua', models.ForeignKey(db_column='Len_idLengua', on_delete=django.db.models.deletion.DO_NOTHING, to='appInfancia.lengua')),
            ],
            options={
